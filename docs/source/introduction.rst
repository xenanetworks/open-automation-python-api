...
.. important::
    ...
    Starting from `xoa-driver v2.1.1`, the XOA Python API provides seamlessly integration with CLI commands and port configuration files from `ValkyrieManager <https://xenanetworks.com/product/valkyriemanager/>_`.
