...
class ArpChunk:
    ...
    prefix: XmpField[xt.XmpShort] = XmpField(xt.XmpShort)
    """The IP prefix used for address matching."""

    patched_mac: XmpField[xt.XmpByte] = XmpField(xt.XmpByte, choices=OnOff)
