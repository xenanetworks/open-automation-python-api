...
class PEF_ETHSRCADDR:
    ...
    class SetDataAttr:
        ...
        value: XmpField[xt.XmpHex6] = XmpField(xt.XmpHex6)
...
class PEF_VLANTAG:
    ...
    class SetDataAttr:
        ...
        value: XmpField[xt.XmpInt] = XmpField(xt.XmpInt)
...
class PEF_VLANPCP:
    ...
    class SetDataAttr:
        ...
        value: XmpField[xt.XmpByte] = XmpField(xt.XmpByte)
...
class PEF_IPV4SRCADDR:
    ...
    class SetDataAttr:
        ...
        value: XmpField[xt.XmpIPV4Address] = XmpField(xt.XmpIPV4Address)
...
class PEF_IPV6SRCADDR:
    ...
    class SetDataAttr:
        ...
        value: XmpField[xt.XmpIPV6Address] = XmpField(xt.XmpIPV6Address)
