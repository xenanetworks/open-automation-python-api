...
class License:
    ...
    def __init__(self, conn: "itf.IConnection", module_id: int) -> None:
        ...
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m_commands.M_LICENSE_DEMO_INFO`
        """
        self.management_info = M_LICENSE_MAINTENANCE_INFO(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m_commands.M_LICENSE_MAINTENANCE_INFO`
        """
        self.clock_windback = M_LICENSE_CWB_DETECTED(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m_commands.M_LICENSE_CWB_DETECTED`
        """
        self.update = M_LICENSE_UPDATE(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m_commands.M_LICENSE_UPDATE`
        """
        self.update_status = M_LICENSE_UPDATE_STATUS(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m_commands.M_LICENSE_UPDATE_STATUS`
        """
        self.list_bson = M_LICENSE_LIST_BSON(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m_commands.M_LICENSE_LIST_BSON`
        """
        self.online_mode = M_LICENSE_ONLINE(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m_commands.M_LICENSE_ONLINE`
        """
...
class CaptureParse:
    ...
    def __init__(self, conn: "itf.IConnection", module_id: int) -> None:
        ...
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_REPLAY_PARSE_START`
        """
        self.stop = M4_REPLAY_PARSE_STOP(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_REPLAY_PARSE_STOP`
        """
        self.state = M4_REPLAY_PARSE_STATE(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_REPLAY_PARSE_STATE`
        """
        self.parser_params = M4_REPLAY_PARSER_PARAMS(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_REPLAY_PARSER_PARAMS`
        """
...
class ReplayFile:
    ...
    def __init__(self, conn: "itf.IConnection", module_id: int) -> None:
        ...
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_REPLAY_FILE_LIST_BSON`
        """
        self.list = M4_REPLAY_FILE_LIST(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_REPLAY_FILE_LIST`
        """
        ...
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_REPLAY_FILE_DELETE`
        """
...
class Capture:
    ...
    def __init__(self, conn: "itf.IConnection", module_id: int) -> None:
        ...
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_CAPTURE_SIZE`
        """
        self.file_list_bson = M4_CAPTURE_FILE_LIST_BSON(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_CAPTURE_FILE_LIST_BSON`
        """
        self.file_list = M4_CAPTURE_FILE_LIST(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_CAPTURE_FILE_LIST`
        """
        self.file_delete = M4_CAPTURE_FILE_DELETE(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_CAPTURE_FILE_DELETE`
        """
...
class PacketEngine:
    ...
    def __init__(self, conn: "itf.IConnection", module_id: int) -> None:
        ...
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_LICENSE_INFO`
        """
        self.reserve = M4E_RESERVE(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4e_commands.M4E_RESERVE`
        """
        self.mode = M4E_MODE(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4e_commands.M4E_MODE`
        """
...
class ModuleSystem:
    ...
    def __init__(self, conn: "itf.IConnection", module_id: int) -> None:
        ...
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M_COMMEM4_SYSTEMIDNT`
        """
        self.status = M4_SYSTEM_STATUS(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_SYSTEM_STATUS`
        """
        self.time = M4_SYSTEM_TIME(conn, module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_SYSTEM_TIME`
        """
...
class ModuleL47(bm.BaseModule):
    ...
    def __init__(self, conn: "itf.IConnection", init_data: "m_itf.ModuleInitData") -> None:
        ...
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_VERSIONNO`
        """
        self.compatible_client_version = M4_COMPATIBLE_CLIENT_VERSION(conn, self.module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_COMPATIBLE_CLIENT_VERSION`
        """
        self.time = M4_TIME(conn, self.module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_TIME`
        """
        self.tls_chiper = M4_TLS_CIPHER_SUITES(conn, self.module_id)
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_TLS_CIPHER_SUITES`
        """
        self.memory_info = M4_MEM_INFO(conn, self.module_id) # Not sure if suppose to be here, maybe under ModuleSystem
        """High-level representation of :class:`~xoa_driver.internals.core.commands.m4_commands.M4_MEM_INFO`
        """
